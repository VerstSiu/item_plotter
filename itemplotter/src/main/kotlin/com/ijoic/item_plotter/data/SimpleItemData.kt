...
class SimpleItemData: ItemData {
  ...
  private val valueMap = ConcurrentHashMap<String, String>()

  override fun getString(bindKey: String) = valueMap[bindKey]
   ...
   */
  fun putStringValue(bindKey: String, value: String?) {
    if (value == null) {
